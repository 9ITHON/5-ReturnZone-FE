...
const CalendarModal = forwardRef(({ onClose, onSelect }, ref) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-center items-end bg-[#11111180]">
            <div
                ref={ref}
                className="bg-white rounded-t-[20px] w-full max-w-md px-[24px] pt-[20px] pb-[32px]"
            >
                <h2 className="text-[16px] text-[#111111] font-semibold text-center py-[11px] px-[24px]">
                    날짜 선택
                </h2>
                <DayPicker
                    mode="single"
