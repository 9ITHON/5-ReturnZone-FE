...
const BottomNav = () => (
  <nav className="absolute left-0 right-0 bottom-0 h-[88px] flex flex-col items-center p-0 bg-white border-t border-t-[#B8B8B8] border-opacity-50">
    <div className="flex flex-row  w-[390px] h-[88px] self-stretch justify-center items-center p-0">
